...
export const PriceForm = ({id,refetch}:any) => {
    ...
    const handleSubmit = async (values: FieldValues) => {
        ...
        try {
          ...
          if (res) {
            ...
            const routePrefix = "/admin/ready-batch/waiting-list"; // Define the route prefix
      ...
      >
        ...
        <div>
              <label className="mb-1 block text-sm font-medium text-black dark:text-white">
                Set Selling Price (Per KG) <span className="text-danger">*</span>
              </label>
              <SportsInput
                type="number"
                name="selling_price"
