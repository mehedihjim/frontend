...
export const ReadyBatchTable = ({routePrefix, readyBatchData, isLoading ,onView} : any) => {
     const [currentPage, setCurrentPage] = useState(1);
      ...
      const currentItems = readyBatchData?.data?.slice(
        indexOfFirstItem,
        indexOfLastItem,
      );
    
      // Determine the total number of pages
      const totalPages = Math.ceil(readyBatchData?.data?.length / itemsPerPage);
            ...
            {displayData?.map((data) => {
              ...
              return (
                <tr key={data.id} className="border-b-1 border border-l-0 border-r-0 border-t-0 border-slate-200 dark:border-slate-700">
                  ...
                  <td className="text-blueGray-700 whitespace-nowrap border-l-0 border-r-0 border-t-0 p-4 px-6 text-left align-middle text-xs">{data.start_date}</td>
                    <th className="text-blueGray-700 whitespace-nowrap border-l-0 border-r-0 border-t-0 p-4 px-6 text-left align-middle text-xs">{data.farmer_name}</th>
                  ...
                  <td className="text-blueGray-700 whitespace-nowrap border-l-0 border-r-0 border-t-0 p-4 px-6 text-left align-middle text-xs">{data.chick_number}</td>
                  ...
                  <td className="text-blueGray-700 whitespace-nowrap border-l-0 border-r-0 border-t-0 p-4 px-6 text-left align-middle text-xs">{data.chick_price}</td>
