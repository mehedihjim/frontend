...
import SymptomsComponent from "../../new-prescription-list/component/Symtoms"
import { useSinglePrescriptionQuery } from "@/redux/api/prescriptionApi";

export const PreviousPrescriptionView = ({prescription_id}:any) => {
                            ...
                            <tr className="p-0">
                                ...
                                <td colSpan={3} style={{ verticalAlign: "top" }} className="p-0">
                                    <table className="table w-full">
                                        <thead>
                                            <tr>
                                                <th className="text-slate-600">No.</th>
                                                <th className="text-slate-600 text-center">Medicine</th>
                                                <th className="text-slate-600 text-center">Type</th>
                                                <th className="text-slate-600 text-center">Quantity</th>
                                                <th className="text-slate-600 text-center">Dosage</th>
                                                <th className="text-slate-600 text-center">Duration</th>
                                                <th className="text-slate-600 text-center">Note</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                ...
                                <td colSpan={3} className="border-b border-r" >
                                    <div className="flex gap-5">
                                       <div className="input-container w-50">
                                           ...
                                           {prescribeData?.data.medicine[0]?.date ?? 'N/A'}
                                        </div>
                                        <div className="input-container w-50">
                                            <label className="mb-1 block text-sm font-bold dark:text-white">
                                                Follow Up:
                                            </label>
                                           {prescribeData?.data.followup_date ?? 'N/A'}
                                        </div> 
                                    </div>
