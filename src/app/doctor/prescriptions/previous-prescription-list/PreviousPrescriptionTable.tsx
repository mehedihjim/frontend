...
export const PreviousPrescriptionTable = ({routePrefix,onView} : any) => {
     const [currentPage, setCurrentPage] = useState(1);
      const [itemsPerPage, setItemsPerPage] = useState(10);
      const [displayData, setDisplayData] = useState<any[]>([]);
     const {data: panddingPrescription , isLoading: isPendingPrescriptionLoading} = usePrescritptionListByStatusQuery("Completed"); 
