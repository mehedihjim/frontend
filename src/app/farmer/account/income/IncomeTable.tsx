...
export const IncomeTable = ({
  ...
  const currentItems = incomeData?.data?.slice(
    indexOfFirstItem,
    indexOfLastItem,
  );

  // Determine the total number of pages
  const totalPages = Math.ceil(incomeData?.data?.length / itemsPerPage);
  if (isLoading) return <p>Loading...</p>;
  return (
    <>
      <div className="mb-6 mt-6 ">
        <div className="table-headline mb-6 dark:text-white">Income List</div>
      </div>
